...
import json
import copy
from ibioml.utils.models.models import train_model
...
def nested_cv_optuna(X, y, T, model_space, num_trials=5, outer_folds=5, inner_folds=5, save_path="results", search_alg="bayes", search_space=None, study_name=None):
    """
